...
{
if ($_SESSION['username']=== $dnn["AUTHOR_ID"]){
?>
...
<div class="row"></div>
<br><center>
<a id="delete_event" onclick="return confirm('Είστε σίγουροι ότι επιθυμείτε την διαγραφή αυτής της καταχώρησης;... ');" href='delete.php?id=<?php echo $dnn['ID_EVENT']; ?>'>Διαγραφή Καταχώρησης</a>
</center>
